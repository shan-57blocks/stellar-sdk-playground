const sendTx = async () => {
  ...
  const contractAddress =
    "CAEZYPRZLQO2X5ZLIFD3OLCCNLFQS7AVTRSCIAPWMCGKKVWML4TJF73E";
  ...
  let builtTransaction = new TransactionBuilder(sourceAccount, {
    ...
    .addOperation(contract.call("hello", xdr.ScVal.scvSymbol("RPC")))
  ...
  try {
    ...
    if (sendResponse.status === "PENDING") {
      ...
      if (getResponse.status === "SUCCESS") {
        ...
        console.log(
          `Transaction result: ${JSON.stringify(returnValue.value())}`
        );
      } else {
